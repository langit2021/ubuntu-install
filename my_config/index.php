...
// File: index.php
// Description: Interactive / Info Control Panel (4-Column Layout)
// ============================================================
...
// 2. 檢測 Cron 排程 (直接檢測系統 Root 的 crontab 狀態檔是否存在)
...
<div class="card-grid">
    ...
    <div class="card info">
        ...
        <ul>
            ...
            <li><span>SFTP/SSH 密碼</span> <code><?php echo htmlspecialchars($op_pass); ?></code></li>
